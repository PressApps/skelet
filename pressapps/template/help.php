...
<header class="pa-header">
	...
	<p>Look for help below, get premium services or ask a question</p>
</header>

<ul class="pa-boxes">
	<li>
		<a href="http://pressapps.co/docs/">
			<i class="sk-icon fa fa-file-text-o"></i>
			<h3><?php _e( 'Documentation', SK_TEXTDOMAIN ); ?></h3>
			<p>Learn how to install, setup and use our products</p>
		</a>
	</li>
	<li>
		<a href="http://help.pressapps.co/">
...
<ul class="pa-boxes">
	<li>
		<a href="http://pressapps.co/priority/">
			<i class="sk-icon fa fa-life-ring"></i>
			<h3><?php _e( 'Priority Support', SK_TEXTDOMAIN ); ?></h3>
			<p>Sign up to always be at the front of the queue and get rapid support</p>
		</a>
	</li>
	<li>
		<a href="http://pressapps.co/customization/">
			<i class="sk-icon fa fa-code"></i>
			<h3><?php _e( 'Customization', SK_TEXTDOMAIN ); ?></h3>
			<p>Do you want to customise our product and don't have the time or skills</p>
		</a>
	</li>
</ul>
